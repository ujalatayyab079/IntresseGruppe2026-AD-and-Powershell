# IntresseGruppe2026-Active Directory(AD)-and-Powershell
...
- Strukturering av OU-er for elever, undervisere og ledelse
- Underinndeling av elever i klassetrinn (1–7 klasse)
- Oppsett av Group Policy Objects (GPO)
- Konfigurasjon av skrivebordsbakgrunn og skjermsparer
...
- Virtuell maskin (Hyper-V / VirtualBox)
